...
/// copy P_GRAD to P_GRAD_SUM, set P_GRAD = 0
void ParameterServer2::op_COPY_ZERO(const Operation& operation,
                                    OperationResult* result) {
  (void)result;
  real* u = vectors_[operation.pvectors(0)]->getData();
  real* v = vectors_[operation.pvectors(1)]->getData();
...
ParameterServer2::OperatorFunction ParameterServer2::opFuncs[] = {
    ...
    &ParameterServer2::op_COPY_ZERO,      // PSERVER_OP_COPY_ZERO = 18;
};
