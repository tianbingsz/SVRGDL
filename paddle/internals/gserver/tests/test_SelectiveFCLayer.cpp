...
void calcOutput(ComData& comData, const string configFile,
  ...
  FLAGS_init_model_path = "internals/gserver/tests/SelectiveFcTest/model";
...
TEST(Layer, SelectiveFcLayer_train_dense_mul) {
  const string& fcConfig =
      "internals/gserver/tests/SelectiveFcTest/conf/fc.conf";
  const string& fcConfigArgs =
    "filelist=internals/gserver/tests/SelectiveFcTest/dense_mul_list";
  const string& selFcConfig =
      "internals/gserver/tests/SelectiveFcTest/conf/selective_fc.conf";
...
void testSelectiveFcLayerTrainSparseMul(const LayerConfig &config,
  ...
  const string& selfcParaFile =
    "internals/gserver/tests/SelectiveFcTest/model/rand_fc_param.w.transpose";
  ...
  const string& fcParaFile =
    "internals/gserver/tests/SelectiveFcTest/model/rand_fc_param.w";
